...
const App: React.FC = () => {
  ...
  const containerClasses = gameState === GameState.START
    ? "relative w-full h-full max-w-[500px] md:h-auto md:aspect-[9/16] flex flex-col overflow-visible"
    : "relative w-full h-full max-w-[500px] max-h-[100svh] md:max-h-[90svh] md:h-auto md:aspect-[9/16] bg-transparent flex flex-col overflow-visible"; // Transparent, no shadow/rounded for game

  return (
    <div className="relative w-full h-[100svh] bg-transparent flex items-center justify-center overflow-hidden font-sans select-none px-3 md:px-0">
      {/* Global Background Blobs & Glass Effect - Only for Menu */}
