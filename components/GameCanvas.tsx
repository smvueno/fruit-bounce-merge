                 ...
                 <div className="w-full mb-6 bg-slate-50 border border-slate-200 rounded-2xl p-4 shadow-inner flex flex-col overflow-hidden max-h-40">
                     ...
                     <div className="overflow-y-auto pr-2 custom-scrollbar">
                         {sortedLeaderboard.length === 0 ? (
                             <div className="text-center text-slate-400 italic text-sm">No high scores yet</div>
                         ) : (
                             sortedLeaderboard.map((entry, idx) => (
                                 <div key={idx} className="flex justify-between items-center text-sm font-bold text-slate-700 border-b border-slate-100 last:border-0 py-1">
