...
const chorus = [
    ...
    { freq: N.G5, duration: D4 }, { freq: N.F5, duration: D8 }, { freq: N.E5, duration: D8 }, { freq: N.D5, duration: D4 }, { freq: N.C5, duration: D4 - 0.05 }, { freq: N.R, duration: 0.05 }  // G (Turnaround) - Resolve to C5, Shortened to prevent overlap
];
